/* Zepto v1.2.0-6-g32094dc - zepto event ajax - zeptojs.com/license */
/* eslint-disable */

const Zepto = module.exports = (function () {
    let undefined,
        key,
        $,
        classList,
    ...
    $.fn = {
        ...
        ready (callback) {
            ...
            if (document.readyState === 'complete' ||
                    (document.readyState !== 'loading' && !document.documentElement.doScroll)) { setTimeout(() => { callback($); }, 0); } else {
    ...
    $.fn.detach = $.fn.remove
        ...
        ;['width', 'height'].forEach((dimension) => {
            const dimensionProperty =
                dimension.replace(/./, m => m[0].toUpperCase());
