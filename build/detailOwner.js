...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/58fe/project/fang-booking/src/views/detailOwner/index.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-060f11d0", Component.options)
	  } else {
	    hotAPI.reload("data-v-060f11d0", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _statusButtonEnum = __webpack_require__(227);

	var _statusButtonEnum2 = _interopRequireDefault(_statusButtonEnum);
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            ...
	            /*订单状态数据*/
	            dataState: _dataState2.default,
	            /*租客信息数据*/
	            dataPerson: (0, _extends3.default)(_dataPerson2.default, { role: 1 }),
	            /*帖子信息数据*/
	            dataHouse: _dataHouse2.default,
	            /*预订数据*/
	            dataBooking: _dataBooking2.default,
	            /*订单数据*/
	            dataOrder: _dataOrder2.default,

	            /*订单状态与操作枚举数据*/
	            statusButtonEnum: _statusButtonEnum2.default,
	    ...
	    computed: {
	        /*当前订单状态, 显示的操作按钮*/
	        dataButtons: function dataButtons() {
	            var _this = this;
	            var _buttons = {};
	            if (_this.statusButtonEnum[_this.dataState.status]) {
	                ...
	                if ((_this.dataState.status == 7 || _this.dataState.status == 14) && _buttons.withdraw && _this.isWithDrawCash == '0') {
	                    (0, _extends3.default)(_buttons.withdraw, _this.statusButtonDisWithdraw.disWithdraw);
	                }
	                //仲裁中有两种情况使提交证据按钮置灰
	                if (_this.dataState.status == 11 && _buttons.defendant) {
	                    //仲裁中
	                    if (_this.statusButtonDisDefendant.isTimeout) {
	                        //超过提交证据时间
	                        (0, _extends3.default)(_buttons.defendant, _this.statusButtonDisDefendant.timeout);
	                    } else if (_this.statusButtonDisDefendant.isCommitted) {
	                        //已提交过证据
	                        (0, _extends3.default)(_buttons.defendant, _this.statusButtonDisDefendant.committed);
	                    }
	                }
	            }
	            return _buttons;
	    ...
	    methods: {
	         ...
	         * 数据请求: 获取订单信息接口
	         */
	        getOrderInfoById: function getOrderInfoById() {
	            var _this = this;
	            _this.isLoading = true;
	            _this.$request.jsonp({
	                url: _api2.default.getOrderInfoById.url,
	                data: {
	         ...
	         * 数据请求: 获取订单信息接口回调
	         */
	        getOrderInfoByIdCb: function getOrderInfoByIdCb(state, res) {
	            var _this = this;
	            ...
	            if (res && res.code == 0 && res.data) {
	                ...
	                var _res$data$status = _res$data.status;
	                _this.dataState.status = _res$data$status === undefined ? '' : _res$data$status;
	                var _res$data$statusDes = _res$data.statusDes;
	                _this.dataState.statusDes = _res$data$statusDes === undefined ? '' : _res$data$statusDes;
	                var _res$data$statusAct = _res$data.statusAct;
	                _this.dataState.statusAct = _res$data$statusAct === undefined ? '' : _res$data$statusAct;
	                var _res$data$buyerPayDea = _res$data.buyerPayDeadline;
	                _this.dataState.buyerPayDeadline = _res$data$buyerPayDea === undefined ? '' : _res$data$buyerPayDea;
	                var _res$data$buyerDeadli = _res$data.buyerDeadline;
	                _this.dataState.buyerDeadline = _res$data$buyerDeadli === undefined ? '' : _res$data$buyerDeadli;
	                var _res$data$buyerAppeal = _res$data.buyerAppealDeadline;
	                _this.dataState.buyerAppealDeadline = _res$data$buyerAppeal === undefined ? '' : _res$data$buyerAppeal;
	                var _res$data$sellerDeadl = _res$data.sellerDeadline;
	                _this.dataState.sellerDeadline = _res$data$sellerDeadl === undefined ? '' : _res$data$sellerDeadl;
	                var _res$data$sellerRefun = _res$data.sellerRefundDeadline;
	                _this.dataState.sellerRefundDeadline = _res$data$sellerRefun === undefined ? '' : _res$data$sellerRefun;
	                var _res$data$sellerAppea = _res$data.sellerAppealDeadline;
	                _this.dataState.sellerAppealDeadline = _res$data$sellerAppea === undefined ? '' : _res$data$sellerAppea;
	                var _res$data$nowTime = _res$data.nowTime;
	                _this.dataState.nowTime = _res$data$nowTime === undefined ? '' : _res$data$nowTime;
	                var _res$data$buyerId = _res$data.buyerId;
	                _this.dataPerson.userid = _res$data$buyerId === undefined ? '' : _res$data$buyerId;
	                var _res$data$orderDetail = _res$data.orderDetail;
	                var _res$data$orderDetail2 = _res$data$orderDetail.buyerPic;
	                _this.dataPerson.pic = _res$data$orderDetail2 === undefined ? '' : _res$data$orderDetail2;
	                var _res$data$orderDetail3 = _res$data$orderDetail.buyerName;
	                _this.dataPerson.name = _res$data$orderDetail3 === undefined ? '' : _res$data$orderDetail3;
	                var _res$data$orderDetail4 = _res$data$orderDetail.buyerCardId;
	                _this.dataPerson.cardId = _res$data$orderDetail4 === undefined ? '' : _res$data$orderDetail4;
	                var _res$data$orderDetail5 = _res$data$orderDetail.buyerPhone;
	                _this.dataPerson.phone = _res$data$orderDetail5 === undefined ? '' : _res$data$orderDetail5;
	                var _res$data$infoDetail$ = _res$data.infoDetail.infoId;
	                _this.dataPerson.infoId = _res$data$infoDetail$ === undefined ? '' : _res$data$infoDetail$;
	                var _res$data$infoDetail = _res$data.infoDetail;
	                var _res$data$infoDetail$2 = _res$data$infoDetail.infoId;
	                _this.dataHouse.infoId = _res$data$infoDetail$2 === undefined ? '' : _res$data$infoDetail$2;
	                var _res$data$infoDetail$3 = _res$data$infoDetail.title;
	                _this.dataHouse.title = _res$data$infoDetail$3 === undefined ? '' : _res$data$infoDetail$3;
	                var _res$data$infoDetail$4 = _res$data$infoDetail.picUrl;
	                _this.dataHouse.picUrl = _res$data$infoDetail$4 === undefined ? '' : _res$data$infoDetail$4;
	                var _res$data$infoDetail$5 = _res$data$infoDetail.area;
	                _this.dataHouse.area = _res$data$infoDetail$5 === undefined ? '' : _res$data$infoDetail$5;
	                var _res$data$infoDetail$6 = _res$data$infoDetail.pLocalName;
	                _this.dataHouse.pLocalName = _res$data$infoDetail$6 === undefined ? '' : _res$data$infoDetail$6;
	                var _res$data$infoDetail$7 = _res$data$infoDetail.pAreaLocalName;
	                _this.dataHouse.pAreaLocalName = _res$data$infoDetail$7 === undefined ? '' : _res$data$infoDetail$7;
	                var _res$data$infoDetail$8 = _res$data$infoDetail.chaoXiang;
	                _this.dataHouse.chaoXiang = _res$data$infoDetail$8 === undefined ? '' : _res$data$infoDetail$8;
	                var _res$data$infoDetail$9 = _res$data$infoDetail.price;
	                _this.dataHouse.price = _res$data$infoDetail$9 === undefined ? '' : _res$data$infoDetail$9;
	                var _res$data$infoDetail$10 = _res$data$infoDetail.nativeApp;
	                _this.dataHouse.nativeApp = _res$data$infoDetail$10 === undefined ? '' : _res$data$infoDetail$10;
	                var _res$data$totalAmount = _res$data.totalAmount;
	                _this.dataBooking.totalAmount = _res$data$totalAmount === undefined ? '' : _res$data$totalAmount;
	                var _res$data$orderDetail6 = _res$data.orderDetail.checkInDate;
	                _this.dataBooking.checkInDate = _res$data$orderDetail6 === undefined ? '' : _res$data$orderDetail6;
	                var _res$data$orderId = _res$data.orderId;
	                _this.dataOrder.orderId = _res$data$orderId === undefined ? '' : _res$data$orderId;
	                var _res$data$createTime = _res$data.createTime;
	                _this.dataOrder.createTime = _res$data$createTime === undefined ? '' : _res$data$createTime;
	                var _res$data$tradeNo = _res$data.tradeNo;
	                _this.dataOrder.tradeNo = _res$data$tradeNo === undefined ? '' : _res$data$tradeNo;
	                var _res$data$transferNo = _res$data.transferNo;
	                _this.dataOrder.transferNo = _res$data$transferNo === undefined ? '' : _res$data$transferNo;
	                var _res$data$payTime = _res$data.payTime;
	                _this.dataOrder.payTime = _res$data$payTime === undefined ? '' : _res$data$payTime;
	                var _res$data$agreeTime = _res$data.agreeTime;
	                _this.dataOrder.agreeTime = _res$data$agreeTime === undefined ? '' : _res$data$agreeTime;
	                var _res$data$checkinTime = _res$data.checkinTime;
	                _this.dataOrder.checkinTime = _res$data$checkinTime === undefined ? '' : _res$data$checkinTime;
	                var _res$data$successTime = _res$data.successTime;
	                _this.dataOrder.successTime = _res$data$successTime === undefined ? '' : _res$data$successTime;
	                var _res$data$closeTime = _res$data.closeTime;
	                _this.dataOrder.closeTime = _res$data$closeTime === undefined ? '' : _res$data$closeTime;
	                var _res$data$isWithDrawC = _res$data.isWithDrawCash;
	                _this.isWithDrawCash = _res$data$isWithDrawC === undefined ? '' : _res$data$isWithDrawC;
	         ...
	         */
	        disDefendant: function disDefendant() {
	            var _this = this;
	            //非调解中状态的订单不做处理
	            if (_this.dataState.status != 11) {
	                return;
	            ...
	            var _ref = [_this.dataState.nowTime, _this.dataState.sellerAppealDeadline],
	                _nowTime = _ref[0],
	                _sellerAppealDeadline = _ref[1];

	            if (_this.$util.isDateTimeStr(_nowTime) && _this.$util.isDateTimeStr(_sellerAppealDeadline)) {
	                var _sTime = new Date(_nowTime.replace(/-/g, "/")).getTime();
	                var _eTime = new Date(_sellerAppealDeadline.replace(/-/g, "/")).getTime();
	         ...
	         */
	        isDefendantCommittedRequest: function isDefendantCommittedRequest() {
	            var _this = this;
	            _this.$request.jsonp({
	                url: _api2.default.defendantIsUncommitted.url,
	                data: {
	         ...
	         * 操作按钮: 入口
	         */
	        handlerClickButton: function handlerClickButton(dataButton) {
	            var _this = this;
	            var _action = dataButton.action;
	            //埋点
	            var _log = dataButton.log;
	            if (_log) {
	                _this.trackLog(_log);
	            }
	            switch (_action) {
	                ...
	                case 'agreeRent':
	                    //同意出租
	                    if (dataButton.dialog) {
	                        var _dialog2 = dataButton.dialog;
	                        var _content = _dialog2.content.replace("#name#", _this.dataPerson.name);
	                        (0, _extends3.default)(_this.dataDialogCommon, {
	                            show: true,
	                            action: _action,
	                            title: _dialog2.title,
	                            content: _content,
	                            buttons: [_dialog2.text1, _dialog2.text2]
	                        });
	                    }
	                    break;
	                case 'agreeRefund':
	                    //房东同意退款
	                    if (dataButton.dialog) {
	                        var _dialog3 = dataButton.dialog;
	                        _this.$app.showDialog('double', _dialog3.title, _dialog3.content, _this.agreeRefund, _dialog3.text1, _dialog3.text2);
	                    }
	                    break;
	                case 'disagreeRefund':
	                    //房东拒绝退款
	                    if (dataButton.dialog) {
	                        var _dialog4 = dataButton.dialog;
	                        _this.$app.showDialog('double', _dialog4.title, _dialog4.content, _this.disagreeRefund, _dialog4.text1, _dialog4.text2);
	                    }
	                    break;
	                case 'defendant':
	                    //提交证据
	                ...
	                case 'withdraw':
	                    //提取现金
	                    //版本判断
	                    var _ref2 = [_this.$app.getAppVersion(), _this.$app.getAppVersionOn()],
	                        _currentAppVersion = _ref2[0],
	                        _getAppVersionOn = _ref2[1];

	                    var isEgt = _this.$util.compareEgt(_currentAppVersion, _getAppVersionOn);
	                    if (!isEgt) {
	                        _this.$app.showDialog("single", "版本过低", "升级58app至最新版本才可微信提现哦~", function (index) {}, "好");
	                    } else {
	                ...
	                case 'withdrawEnd':
	                    if (dataButton.toast) {
	                        var _toast2 = dataButton.toast;
	                        _this.$app.toastMsg(_toast2.content);
	                    }
	                    break;
	                case 'disWithdraw':
	                    //禁止提现处理
	         ...
	         * 操作按钮: 同意出租操作
	         */
	        handlerDialogCommonButton: function handlerDialogCommonButton(action, index) {
	            var _this = this;
	            switch (action) {
	                case 'agreeRent':
	                    //同意出租
	         ...
	         * 操作按钮: 取消订单操作
	         */
	        cancelOrder: function cancelOrder(index) {
	            if (index == 1) {
	                this.buttonRequest(_api2.default.cancelOrder.url);
	            }
	        },
	         ...
	         * 操作按钮: 同意出租操作
	         */
	        agreeRentOrder: function agreeRentOrder(index) {
	            if (index == 1) {
	                this.buttonRequest(_api2.default.confirmOrder.url);
	            }
	        },
	         ...
	         * 操作按钮: 房东同意退款
	         */
	        agreeRefund: function agreeRefund(index) {
	            var _this = this;
	            if (index == 1) {
	                this.buttonRequest(_api2.default.confirmRefund.url, { isAgree: 1 });
	            }
	        },
	         ...
	         * 操作按钮: 房东拒绝退款操作
	         */
	        disagreeRefund: function disagreeRefund(index) {
	            var _this = this;
	            if (index == 1) {
	                this.buttonRequest(_api2.default.confirmRefund.url, { isAgree: 2 });
	            }
	        },
	         ...
	         * requestData: 扩展参数
	         */
	        buttonRequest: function buttonRequest(requestUrl, requestData) {
	            var _this = this;
	            _this.isLoading = true;

	            var _data = (0, _extends3.default)({
	                orderId: _this.orderId,
	                role: _this.role
	            }, requestData);
	         ...
	         * 用户是否做过人脸认证
	         */
	        userFaceAuthRequest: function userFaceAuthRequest(cb, message) {
	            var _this = this;
	            _this.isLoading = true;
	            _this.$request.jsonp({
	                url: _api2.default.userFaceAuth.url,
	                jsonpName: "jsoncallback",
	                callback: function callback(state, res) {
	                    _this.isLoading = false;
	                    if (res.code == 0) {
	                        if (res.data == 1) {
	                            ...
	                            //人脸认证未通过
	                            var _ref3 = [_this.$app.getAppVersion(), _this.$app.getAppVersionFaceAuth()],
	                                _appVersion = _ref3[0],
	                                _faceAuthVersion = _ref3[1];

	                            var isEgt = _this.$util.compareEgt(_appVersion, _faceAuthVersion);
	                            if (!isEgt) {
	                                _this.$app.showDialog("single", "版本过低", "升级58app至最新版本才可" + message + "哦~", function (index) {}, "好");
	                            } else {
	                                _this.$app.openFaceSdk("人脸认证", '3', function (state) {
	                                    if (state == 0) {
	                                        if (typeof cb == 'function') {
	                                            cb();
	                                        }
	                                    } else if (status == 2) {
	                                        _this.$app.showDialog("single", "提示", "您取消了人脸认证,请先认证再进行" + message + "操作", function (index) {}, "确定");
	                                    } else {
	                                        _this.$app.showDialog("single", "提示", "人脸认证失败,请稍后再试!", function (index) {}, "确定");
	                                    }
	                                });
	                            }
	                        }
	         ...
	         *  操作按钮: 提交证据操作
	         */
	        defendantOrder: function defendantOrder() {
	            var _this = this;
	            var dataButton = _this.statusButtonEnum[11].defendant;
	            if (dataButton && dataButton.dialog) {
	                var _dialog = dataButton.dialog;
	                _this.$app.showDialog('double', _dialog.title, _dialog.content, function (index) {
	                    if (index == 1) {
	                        var _loadPage = dataButton.loadPage;
	                        var _url = _loadPage.url + "?orderNo=" + _this.orderId + "&redirectUrl=" + window.location.href;
	         ...
	         *  操作按钮: 提现操作
	         */
	        bindWechatRequest: function bindWechatRequest() {
	            var _this = this;
	            _this.isLoading = true;
	            _this.$request.post({
	                url: _api2.default.bindWechat.url,
	                data: {
	                    appId: _this.appId
	                },
	                callback: function callback(state, res) {
	         ...
	         */
	        wechatBind: function wechatBind(type) {
	            var _this = this;
	            var _ref4 = [_this.$app.getAppVersion(), _this.$app.getAppVersionWechatBind()],
	                _currentVersion = _ref4[0],
	                _wechatBindVersion = _ref4[1];

	            var isEgt = _this.$util.compareEgt(_currentVersion, _wechatBindVersion);
	            if (!isEgt) {
	                _this.$app.nativeBridge({
	                    action: "pagetrans",
	                    tradeline: "core",
	                ...
	                if (type == 'bind') {
	                    ...
	                    window.wechatUnbindAccountCallback = function (code) {
	                        ...
	                        if (code == 0) {
	                            _this.$app.showDialog("double", "提示", "您的微信已解绑成功,是否重新绑定微信,并提取现金？", function (index) {
	                                if (index == 1) {
	                                    _this.bindWechatRequest();
	                                }
	                            }, "我再想想", "更换微信");
	         ...
	         *  取消按钮: cancel
	         */
	        handlerDialogWithdrawButton: function handlerDialogWithdrawButton(action) {
	            var _this = this;
	         ...
	         * 数据请求: 订单提现
	         */
	        withdrawCashRequest: function withdrawCashRequest() {
	            var _this2 = this;

	            var _this = this;
	            _this.isLoading = true;
	            _this.$request.post({
	                url: _api2.default.withdrawCash.url,
	                data: {
	                    orderId: _this.orderId
	                },
	                callback: function callback(state, res) {
	         ...
	         * 数据请求: 订单提现状态更新接口
	         */
	        getTransferResultRequest: function getTransferResultRequest() {
	            var _this = this;
	            _this.$request.post({
	                url: _api2.default.getTransferResult.url,
	                data: {
	                    orderId: _this.orderId
	                },
	                callback: function callback(state, res) {
	                    ...
	                    if (res.code == 0) {
	                        ...
	                        if (res.data.status == -1) {
	                            ...
	                            if (res.data.message == 'NAME_MISMATCH' || res.data.message == 'V2_ACCOUNT_SIMPLE_BAN') {
	                                ...
	                                _this.$app.showDialog("single", "提现失败", res.data.reason, function (index) {}, "好");
	                            }
	                        }
	                    } else {
	                        _this.$app.toastMsg("服务器开小差...");
	        ...
	        trackLog: function trackLog(actiontype) {
	            ...
	            var _this = this;
	            var _pagetype = _this.dataLog.pagetype;
	            _this.$app.webLog(actiontype, _pagetype);
	        }
	    },
	    components: {
	        DetailState: _components.DetailState,
	        DetailPerson: _components.DetailPerson,
	        DetailHouse: _components.DetailHouse,
	        Detailbooking: _components.Detailbooking,
	        DetailOrder: _components.DetailOrder,
	        DetailButton: _components.DetailButton,
	        DetailBottomBar: _components.DetailBottomBar,
	        AgreementRadio: _components.AgreementRadio,
	        DialogCommon: _components.DialogCommon,
	        DialogWithdraw: _components.DialogWithdraw
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var statusButtonEnum = {
	    ...
	    11: {
	        defendant: {
	            ...
	            loadPage: {
	                title: "",
	                url: _api2.default.defendantShow.url
	            },
	...
	exports.default = statusButtonEnum;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('article', {
	    staticClass: "detailOwnerBox",
	    class: [_vm.dataDialogCommon.show ? 'stopPageScroll' : '']
	  }, [_c('DetailState', {
	    attrs: {
	      "data-state": _vm.dataState
	    }
	  }), _vm._v(" "), _c('DetailPerson', {
	    attrs: {
	      "data-user": _vm.dataPerson
	    }
	  }), _vm._v(" "), _c('DetailHouse', {
	    attrs: {
	      "data-house": _vm.dataHouse
	    }
	  }), _vm._v(" "), _c('Detailbooking', {
	    attrs: {
	      "data-booking": _vm.dataBooking
	    }
	  }), _vm._v(" "), _c('DetailOrder', {
	    attrs: {
	      "data-order": _vm.dataOrder
	    }
	  }), _vm._v(" "), (Object.keys(_vm.dataButtons).length > 0) ? _c('DetailBottomBar', _vm._l((_vm.dataButtons), function(dataButton, index) {
	    return _c('DetailButton', {
	      key: 'DetailButton_' + index,
	      attrs: {
	        "data-button": dataButton
	      },
	      on: {
	        "click": function($event) {
	          _vm.handlerClickButton(dataButton)
	        }
	      }
	    })
	  })) : _vm._e(), _vm._v(" "), _c('DialogCommon', {
	    attrs: {
	      "data-dialog": _vm.dataDialogCommon
	    },
	    on: {
	      "clickButton": _vm.handlerDialogCommonButton
	    }
	  }, [_c('AgreementRadio', {
	    attrs: {
	      "data-agreement": _vm.dataAgreement
	    },
	    model: {
	      value: (_vm.dataAgreement.value),
	      callback: function($$v) {
	        _vm.dataAgreement.value = $$v
	      },
	      expression: "dataAgreement.value"
	    }
	  })], 1), _vm._v(" "), _c('DialogWithdraw', {
	    attrs: {
	      "data-dialog": _vm.dataDialogWithdraw
	    },
	    on: {
	      "clickButton": _vm.handlerDialogWithdrawButton
	    }
	  }), _vm._v(" "), _c('Loading', {
	    attrs: {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-060f11d0", module.exports)
	  }
	}
